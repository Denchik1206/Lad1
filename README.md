...
ни из 4 квадратов. Хотя бы 2 квадрата должны совпадать. Также будем считать, что максимальный размер стороны 
квадрата равен 10<sup>5</sup>.

|             | Тип         | min значение | max значение   |
|-------------|-------------|--------------|----------------|
| A (Число 1) | Целое число | 1            | 10<sup>5</sup> |
| B (Число 2) | Целое число | 1            | 10<sup>5</sup> |
| C (Число 3) | Целое число | 1            | 10<sup>5</sup> |
| D (Число 4) | Целое число | 1            | 10<sup>5</sup> |

#### Данные на выход

Т.к. программа должна вывести количество прямоугольников, то на выход мы получим 
одно целое неотрицательное число. А max количество прямоугольников мы получаем, 
когда все квадраты равны, и это кол-во равно 6

|         | Тип         | min значение | max занчение |
|---------|-------------|--------------|--------------|
| Число 1 | Целое число | 0            | 6            |


### 3. Выбор структуры данных

Программа получает на вход 4 целых числа, которые больше 1. Поэтому для хранения данных выделим 
4 переменных (`a`, `b`, `c` и `d`) типа `int`. Типа данных `int` нам будет достаточно, т.к
10<sup>5</sup> < 2<sup>14</sup>, а 2<sup>14</sup> < 2<sup>31</sup>
...
3. **Проверка совпадения квадратов и других условий для нахождения числа прямоугольников:** 
   - 6 прямоугольников: *можно получить, когда все квадрата равны.*
